...
[theBoss,"sideChat",_texto] remoteExec ["A3A_fnc_commsMP",[friendlySide,civilian]];
...
if (_tipoArty == "BARRAGE") then
	...
	[petros,"sideChat",_texto]remoteExec ["A3A_fnc_commsMP",[friendlySide,civilian]];
	[_tiempo] spawn
		{
		private ["_tiempo"];
		_tiempo = _this select 0;
		waitUntil {sleep 1; time > _tiempo};
		[petros,"sideChat","Splash. Out"] remoteExec ["A3A_fnc_commsMP",[friendlySide,civilian]];
		};
	};
