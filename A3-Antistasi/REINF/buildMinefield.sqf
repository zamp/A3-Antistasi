...
if ((_camion distance _posicionTel < 50) and ({alive _x} count units _grupo > 0)) then
	...
	[petros,"hint","Engineer Team deploying mines."] remoteExec ["A3A_fnc_commsMP",[friendlySide,civilian]];
