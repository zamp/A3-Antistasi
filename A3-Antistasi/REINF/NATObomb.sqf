...
if ({lados getVariable [_x,sideUnknown] == friendlySide} count aeropuertos == 0) exitWith {hint "You need to control an airport in order to fulfill this request"};
...
_planefn = [_origpos, _ang, vehSDKPlane, friendlySide] call bis_fnc_spawnvehicle;
