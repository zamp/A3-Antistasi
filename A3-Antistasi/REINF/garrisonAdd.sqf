...
[_tipo,friendlySide,_marcador,1] remoteExec ["A3A_fnc_garrisonUpdate",2];
waitUntil {(_cuenta < count (garrison getVariable _marcador)) or (lados getVariable [_marcador,sideUnknown] != friendlySide)};
