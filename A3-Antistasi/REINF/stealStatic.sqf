...
if (not(lados getVariable [_cercano,sideUnknown] == friendlySide)) exitWith {hint "You have to conquer this zone in order to be able to steal this Static Weapon"};
